// ═══════════════════════════════════════════════════════════
// effects/skillEffects.js — 각 스킬 전용 화려한 렌더링 연출 이펙트 모음
// [AI 도움] LaserCharge, LaserBeam, LaptopFall, MeteorExplosion, SeniorPunchImpact 등 각 스킬 효과들의 색상 톤을 청색/청록색(Blue/Cyan) 계열로 변경했습니다.
// ═══════════════════════════════════════════════════════════
// ═══════════════════════════════════════════════════════════
